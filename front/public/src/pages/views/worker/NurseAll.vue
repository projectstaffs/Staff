            ...
            <div class="container">
                <div class="search_block">
                    ...
                    <form class="search" @submit.prevent="search">
                        <Search :data="searchData" :typework="Store.nursetypeofworks" :city="Store.citys" />
...
export default {
    ...
    methods: {
        watch() { this.Views.WATCH_WORKERNURSE(localStorage.userID); },
        search() { this.Views.SEARCH_WORKERNURSE(this.searchData); },
        clear() { this.Views.GET_WORKERNURSE(); },
        showItem(item) {
    ...
    mounted() {
        this.Store.GET_NURSETYPEOFWORKS(); this.Store.GET_CITYS();
