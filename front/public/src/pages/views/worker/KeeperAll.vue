...
export default {
    ...
    methods: {
        watch() { this.Views.WATCH_WORKERKEEPER(localStorage.userID); },
        search() { this.Views.SEARCH_WORKERKEEPER(this.searchData); },
        clear() { this.Views.GET_WORKERKEEPER(); },
        showItem(item) {
    ...
    mounted() {
        this.Store.GET_HOUSEKEEPERTYPEOFWORKS(); this.Store.GET_CITYS();
