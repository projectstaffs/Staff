            ...
            <div class="container">
                ...
                <div class="search_block">
                    ...
                    <form class="search" @submit.prevent="search">
                        <Search :data="searchData" :typework="Store.babysittingduties" :city="Store.citys" />
...
export default {
    ...
    mounted() {
        this.Store.GET_CITYS(); this.Store.GET_BABYSITTINGDUTIES();

        this.searchData.city = 6;
        this.searchData.typeofwork = 9;
    },
