            ...
            <div class="container">
                ...
                <div class="search_block">
                    ...
                    <form class="search" @submit.prevent="search">
                        <Search :data="searchData" :typework="Store.housekeeperduties" :city="Store.citys" />
...
export default {
    ...
    methods: {
        watch() { this.Views.WATCH_CLIENTKEEPER(localStorage.userID); },
        search() { this.Views.SEARCH_CLIENTKEEPER(this.searchData); },
        clear() { this.Views.GET_CLIENTKEEPER(); },
        showItem(item) {
    ...
    mounted() {
        this.Store.GET_CITYS(); this.Store.GET_HOUSEKEEPERDUTIES();

        this.searchData.typeofwork = 3;
