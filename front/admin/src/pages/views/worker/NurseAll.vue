                            ...
                            <div class="card-body pt-0">
                                <div class="row">
                                    <div class="col-7">
                                        ...
                                        <p class="text-muted text-sm user_fix"><b>Досвід роботи з людьми похилого
                                                віку(укр.): </b>
                                            {{ user.nurse_exp.ua }}
                                        </p>
                                        <p class="text-muted text-sm user_fix"><b>Досвід роботи з людьми похилого
                                        ...
                                        <p class="text-muted text-sm user_fix"><b>Досвід роботи з такими діагнозами
                                                пацієнтів: </b>
                                            <span v-for="(item, index) in user.Diagnoses" :key="index">
                                                {{ item.title.title.ua }}
                                                {{ index < user.Diagnoses.length - 1 ? ', ' : '' }} </span>
                                        </p>
